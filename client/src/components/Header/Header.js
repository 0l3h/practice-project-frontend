        ...
        <div className={styles.headerContainer}>
          ...
          <div className={styles.loginSignnUpHeaders}>
            <div className={styles.numberContainer}>
              ...
              <a style={{textDecoration: 'none'}} href={`tel: ${CONSTANTS.CONTACTS.PHONE_NUMBER}`}>{`${CONSTANTS.CONTACTS.PHONE_NUMBER}`}</a>
            </div>
          ...
          <div className={styles.navContainer}>
            <Logo to='/' src={`${CONSTANTS.STATIC_IMAGES_PATH}blue-logo.png`} className={styles.logo} alt="blue_logo"/>
